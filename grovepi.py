...
#Application pour le serveur web
lumiere_cmd = [100]
...
#Fonction permettant d'activer l'application lumiere du serveur web
def appliLumiere(SB, SH, active):
	write_i2c_block(address, lumiere_cmd + [SB, SH, active])
	time.sleep(.05)
	return 1
